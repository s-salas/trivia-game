const categories = ["CKM Team Trivia", "Fields / Tabs in Change Manager", "Procedures", "RDM Trivia"];
const questions = [
  [
    // CKM Team Trivia
...
function updateDisplay() {
  ...
  // Round milliseconds to two decimal places
  let remainingMillisecondsString = (remainingMilliseconds / 1000).toFixed(2).slice(2);
